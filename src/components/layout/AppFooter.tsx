  ...
  return (
    ...
    >
      ...
      <div
        ...
        data-oid="m1dzm.7"
      >
        <div className="container mx-auto px-4 py-12" data-oid="g4hnh6j">
          <div
            className="flex flex-col md:flex-row items-center justify-between"
            data-oid="j7ijxw4"
          >
            <div className="mb-8 md:mb-0" data-oid="06b3ryp">
              <h3
            ...
            <div className="w-full md:w-auto" data-oid="k4sjk6q">
              <form
            ...
            <div className="flex space-x-4" data-oid="iispji-">
              ...
              {["facebook", "twitter", "instagram", "youtube"].map((social) => (
                <Link
                  ...
                  data-oid="8_fa984"
                >
                  <span className="sr-only" data-oid="7cycnfq">
                    {social}
                  </span>
                  <svg
                    className="h-5 w-5"
      ...
      >
        <div className="container mx-auto px-4 py-6" data-oid="172tv2y">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4" data-oid="43fbjcg">
