...
export default function ChangePassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.newPassword.length < 8) {
      ...
      showNotification('Şifre en az 8 karakter uzunluğunda olmalıdır.', 'error');
      return;
    }
    ...
    try {
      ...
      if (error.message === 'Mevcut şifre yanlış') {
        ...
        message = 'Yeni şifre gereksinimleri karşılamıyor. Lütfen daha güçlü bir şifre seçin.';
      }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-md mx-auto">
          ...
          <div className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
            <p>
              Şifrenizi mi unuttunuz? <Link href="/forgot-password" className="text-secondary hover:text-secondary-dark font-medium">Şifremi Unuttum</Link> sayfasını kullanın.
            </p>
          </div>
        </div>
      </div>
