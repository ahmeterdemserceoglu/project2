            ...
            <>
              {orders.length > 0 ? (
                <div className="space-y-4">
                  {orders.map((order) => (
                    <div key={order.id} className="bg-white dark:bg-dark-light rounded-xl shadow-sm overflow-hidden">
                      <div className="p-6">
                        ...
                        <div className="border-t border-gray-200 dark:border-dark-lighter pt-4 mt-4">
                          <Link 
                ...
                <div className="bg-white dark:bg-dark-light rounded-xl shadow-sm overflow-hidden p-8 text-center">
                  ...
                  <h3 className="mt-2 text-lg font-medium text-gray-900 dark:text-white">Henüz siparişiniz bulunmuyor</h3>
                  <p className="mt-1 text-gray-500 dark:text-gray-400">Ürünlerimize göz atarak alışveriş yapabilirsiniz.</p>
                  <div className="mt-6">
                    <Link 
                      href="/products"
