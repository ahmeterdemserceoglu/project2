...
export default function EmailConfirmedPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-900 to-black py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 p-8 bg-gray-800 rounded-lg shadow-2xl text-center">
        <div>
          ...
          <p className="mt-2 text-gray-300">
            Hesabınız başarıyla doğrulandı. Artık tüm hizmetlerimizden yararlanabilirsiniz.
          </p>
        </div>
